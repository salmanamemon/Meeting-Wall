...
$signature = $error ? 'unavailable' : md5(json_encode([$items, leaderboard('THIS_WEEK'), leaderboard('TODAY'), leaderboard('THIS_WEEK', 'agency'), leaderboard('TODAY', 'agency'), date('Y-m-d')]));
